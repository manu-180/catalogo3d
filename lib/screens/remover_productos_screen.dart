...
class _RemoverProductoScreenState extends State<RemoverProductoScreen> {
  ...
  Future<void> _cargarProductos() async {
    final response =
        await Supabase.instance.client.from('juli3d').select('*');
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Center(child: const CatalogoHeaderWidget(text: 'Remover productos')),
  ...
  onTap: () {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text('¿Estás seguro de que querés eliminar "${producto['titulo']}"?'),
        actions: [
          TextButton(
